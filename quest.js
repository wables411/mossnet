...
/* ---------------- sprites ---------------- */
function sprite(rows,remap,size){const n=size||T;const c=document.createElement('canvas');c.width=c.height=n;const g=c.getContext('2d');
...
const PROFBM=['................................','................................','...FFFFFFFFFFFFFFFFFFFFFFFFFF...','...FAAAAAAAAAAAAAAAAAAAAAAAAE...','...FAAAAAAAAAAAAAAAAAAAAAAAAE...','...FAAAAAAAAAAAAAAAAAAAAAAAAE...','...FAAAAAkkkAAAAAAAAAkkkAAAAE...','...FAAAkkiiikkAAAAAkkiiikkAAE...','...FAAkkiiwiikkAAAkkiiwiikkAE...','...FAAkiwwppiikAAAkiwwppiikAE...','...FAkiiwppppiikAkiiwppppiikE...','...FBkiippppppikBkiippppppikE...','...FBkiippppppikBkiippppppikE...','...FBklllppppiikBklllppppiikE...','...FBkllllppiiikBkllllppiiikE...','...FBBkllliiiikBBBkllliiiikBE...','...FBBkklliiikkBBBkklliiikkBE...','...FCCCkwwwikkCCCCCkwwwikkCCE...','...FCCCCCkkkCCCCCCCCCkkkCCCCE...','...FCCCCtCCCCCCCCCCCtCCCCCCCE...','...FCCCCtCCCCCCCCCCCtCCCCCCCE...','...FCCCCttCCCCCCCCCCttCCCCCCE...','...FCCCCtCCCCCCCCCCCtCCCCCCCE...','...FCCCCtCCCCCCCCCCCtCCCCCCCE...','...FCCCCtCCCCCCCCCCCtCCCCCCCE...','...FDDDDDDDDDDDDDDDDDDDDDDDDE...','...FDDDDDDDDDDDDDDDDDDDDDDDDE...','...FDDDDDDDDDDDDDDDDDDDDDDDDE...','...FDDDDDDDDDDDDDDDDDDDDDDDDE...','...FDDDDDDDDDDDDDDDDDDDDDDDDE...','...FDDDDDDDDDDDDDDDDDDDDDDDDE...','...EEEEEEEEEEEEEEEEEEEEEEEEEE...'];
const PROFBM2=['................................','................................','...FFFFFFFFFFFFFFFFFFFFFFFFFF...','...FAAAAAAAAAAAAAAAAAAAAAAAAE...','...FAAAAAAAAAAAAAAAAAAAAAAAAE...','...FAAAAAAAAAAAAAAAAAAAAAAAAE...','...FAAAAAAAAAAAAAAAAAAAAAAAAE...','...FAAAAAAAAAAAAAAAAAAAAAAAAE...','...FAAAAAAAAAAAAAAAAAAAAAAAAE...','...FAAAAAAAAAAAAAAAAAAAAAAAAE...','...FAAAAAAAAAAAAAAAAAAAAAAAAE...','...FBBBBBBBBBBBBBBBBBBBBBBBBE...','...FBBBBBBBBBBBBBBBBBBBBBBBBE...','...FBBBkkkkkkkBBBBBkkkkkkkBBE...','...FBkkBBBBBBBkkBkkBBBBBBBkkE...','...FBBBBBBBBBBBBBBBBBBBBBBBBE...','...FBBBBBBBBBBBBBBBBBBBBBBBBE...','...FCCCCCtCCCCCCCCCCCtCCCCCCE...','...FCCCCCtCCCCCCCCCCCtCCCCCCE...','...FCCCCCCCCCCCCCCCCCCCCCCCCE...','...FCCCCCCCCCCCCCCCCCCCCCCCCE...','...FCCCCCCCCCCCCCCCCCCCCCCCCE...','...FCCCCCCCCCCCCCCCCCCCCCCCCE...','...FCCCCCCCCCCCCCCCCCCCCCCCCE...','...FCCCCCCCCCCCCCCCCCCCCCCCCE...','...FDDDDDDDDDDDDDDDDDDDDDDDDE...','...FDDDDDDDDDDDDDDDDDDDDDDDDE...','...FDDDDDDDDDDDDDDDDDDDDDDDDE...','...FDDDDDDDDDDDDDDDDDDDDDDDDE...','...FDDDDDDDDDDDDDDDDDDDDDDDDE...','...FDDDDDDDDDDDDDDDDDDDDDDDDE...','...EEEEEEEEEEEEEEEEEEEEEEEEEE...'];
const PROFPAL={A:'#a4d2f2',B:'#b8d3d2',C:'#b9c47c',D:'#8fa24c',E:'#6f8a3c',F:'#e6f4fb',k:'#0b1220',i:'#2f86dc',l:'#7cc5f5',p:'#06101c',w:'#ffffff',t:'#8ecdf7'};
const PROF=sprite(PROFBM,PROFPAL,32),PROF2=sprite(PROFBM2,PROFPAL,32);
const PLROWS={
 ...
 right:['......00000.....','.....0ccccc0....','....0ccccccc0...','...0ccccccccc0..','...000000000000.','....0gbbbbbb0...','....0gbbbgbb0...','....0gbbbbbb0...','.....0bbbbb0....','.....0eeeee0....','....0eeeeeee0...','....0eeeeeeeb0..','....0eeeeeee0...','.....0ffff0.....','.....0f00f0.....','.....00..00.....']};
let PL={};
function hsl(h,s,l){return `hsl(${h|0},${s}%,${l}%)`;}
function buildPlayer(hex){let h=0;for(const ch of String(hex||'guest'))h=(h*31+ch.charCodeAt(0))>>>0;
  const m={c:hsl(h%360,70,52),e:hsl((h>>8)%360,55,48),g:hsl((h>>16)%360,30,22),b:['#f2c9a0','#e8b78d','#c98e64','#8d5a3b'][(h>>24)%4]};
  PL={down:sprite(PLROWS.down,m),up:sprite(PLROWS.up,m),right:sprite(PLROWS.right,m)};
  PL.left=(()=>{const c=document.createElement('canvas');c.width=c.height=T;const g=c.getContext('2d');g.translate(T,0);g.scale(-1,1);g.drawImage(PL.right,0,0);return c;})();}
buildPlayer('guest');
...
function drawLab(){drawSky(0,0,0.08);dots(0,0,W,H,'rgba(255,255,255,0.3)');
  ...
  ctx.save();ctx.translate(36,48+nod);ctx.scale(3,3);ctx.drawImage(blink?PROF2:PROF,0,0);ctx.restore();
